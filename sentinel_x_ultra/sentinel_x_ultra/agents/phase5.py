...
from .phase3 import AgentType, BaseAgent
...
class Vulnerability:
    ...
    owasp_category: str | None = 'A03'  # Software Supply Chain Failures
        ...
        for step in playbook['steps']:
            ...
            try:
                ...
                if step['action'] == 'block_ip':
                    ...
                    step_result['output'] = "Extracted IOCs from incident"
                                    ...
                                    for pattern in patterns:
                                        if re.search(pattern, line, re.IGNORECASE):
                                            findings.append({
                                                ...
                                                'owasp_category': 'A04',
                                                'cwe_id': 'CWE-327',
                                                'description': 'Weak cryptographic algorithm or insecure practice'
                                            })
            ...
            for filename in files:
                if filename in ['.env', 'secrets.yml', 'credentials.yml', 'id_rsa', '.pem']:
                    ...
                    findings.append({
                        ...
                        'cwe_id': 'CWE-200',
                        'severity': 'critical',
                        'description': 'Exposed secrets or credentials file found in repository'
                    })
...
class APISecurityAgent(BaseAgent):
    ...
    def _check_prance(self) -> bool:
        ...
        try:
            from prance import ResolvingParser  # noqa: F401
            return True
        except ImportError:
            return False
                ...
                try:
                    ...
                    if resp.status_code >= 500:
                        results['anomalies'].append({
                            ...
                            'type': 'server_error',
                            'description': 'Server error (5xx) with payload - A10',
                            'owasp_category': 'A10'
                        })
